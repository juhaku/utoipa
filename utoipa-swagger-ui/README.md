...
more details at [serve](https://docs.rs/utoipa-swagger-ui/0.3.0/utoipa_swagger_ui/fn.serve.html) or 
...
```text
[dependencies]
utoipa-swagger-ui = { version = "0.3.0", features = ["actix-web"] }
```

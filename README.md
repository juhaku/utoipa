...
```
[dependencies]
utoipa = { version = "0.1.0.beta.1", features = ["swagger_ui", "actix-web", "actix_extras"] }
```
...
See more details in `swagger_ui` module of [utoipa docs](https://docs.rs/utoipa/0.1.0-beta.1/utoipa/).
